                ...
                DropdownButton<String>(
                  ...
                  onChanged: (String? fontSize) {
                    if (setting.getlanguage() == "Vietnamese") {
                      ...
                      setting.setfontsize2(Trang_thai.Co_chu_English[Trang_thai.Co_chu_Vietnamese.indexOf(fontSize)]);
                    } else {
                      setting.setfontsize2(fontSize!);
                      // chỉnh cho 2 fon_size 2 ngôn ngữ cái đồng bộ
                      setting.setfontsize1(Trang_thai.Co_chu_Vietnamese[Trang_thai.Co_chu_English.indexOf(fontSize)]);
                    }
                  },
                )
              ],
